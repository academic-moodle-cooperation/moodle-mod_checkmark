...
/**
 * The mod_checkmark_example_deleted event.
 *
...
/**
 * An example has been deleted in this event.
 *
 * @package   mod_checkmark
 * @author    Philipp Hager
 * @copyright 2018 Academic Moodle Cooperation {@link http://www.academic-moodle-cooperation.org}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class example_deleted extends \core\event\base {
    /**
     * Init method.
     *
    ...
    /**
     * Convenience method to create event object and return it if example has been deleted.
     *
    ...
    public function get_description() {
        return "Deleted example ".$this->data['other']['id']." in checkmark module with course module id '"
    ...
    public static function get_name() {
        return get_string('eventexampledeleted', 'checkmark');
    }
    ...
    protected function validate_data() {
        ...
        if (empty($this->objectid) || empty($this->objecttable)) {
            throw new \coding_exception('The example_deleted event must define objectid and object table.');
        }
