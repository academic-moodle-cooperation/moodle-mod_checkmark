...
/**
 * The mod_checkmark_user_override_deleted event.
 *
...
/**
 * Event for when a user date override has been deleted by a teacher.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class user_override_deleted extends user_override {
    /**
     * Init method.
     */
    ...
    public static function get_name() {
        return get_string('eventoverridedeleted', 'checkmark');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the override with id '$this->objectid' for the checkmark with " .
