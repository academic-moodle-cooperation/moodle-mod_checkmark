...
/**
 * Cache data source for the checkmark overrides.
 *
 * @package   mod_checkmark
 * @copyright 2023 University of Vienna based on 2021 Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

declare(strict_types=1);

namespace mod_checkmark\cache;

use cache_definition;

/**
 * Class checkmark_overrides
 *
 * @package   mod_checkmark
 * @copyright 2023 University of Vienna based on 2021 Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class overrides implements \cache_data_source {
    ...
    public function load_for_cache($key) {
        ...
        [$checkmarkid, $ug, $ugid] = explode('_', $key);
        $checkmarkid = (int) $checkmarkid;
        ...
        switch ($ug) {
            case 'u':
                ...
                $override = $DB->get_record(
                    'checkmark_overrides',
                    ['checkmark' => $checkmarkid, 'userid' => $userid],
