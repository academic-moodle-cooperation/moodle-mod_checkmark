...
$string['alwaysshowdescription_help'] = 'Wenn deaktiviert, wird die Beschreibung nur während des Abgabezeitraums angezeigt.';
...
$string['pdfpageorientation'] = 'PDF-Seitenausrichtung';
...
$string['pdfprintheader'] = 'PDF-Kopf-/Fußzeile';
...
$string['strsum'] = 'Summe';
$string['pdftextsize'] = 'PDF-Textgröße';
...
$string['availabledate_help'] = 'Beginn der Abgabeperiode. Nach diesem Datum ist es Studenten möglich Abgaben zu tätigen.';
...
$string['cutoffdate_help'] = 'Wenn aktiviert markiert dieses Datum das Ende der Abgabeperiode. Nach diesem Datum können Studenten ncihts mehr abgeben. Wenn deaktivert können Studenten auch nach dem Abgabeende weiter Abgaben tätigen, welche als zu spät gekennzeichnet werden.';
...
$string['duedate_help'] = 'Ende der nominellen Abgabeperiode. Nach diesem Datum ist es Studenten weiterhin möglich abzugeben, wobei ihre Abgaben als zu spät gekennzeichnet werden.';
...
$string['pdfpagesize'] = 'Abgaben pro Seite in PDF Dokument';
