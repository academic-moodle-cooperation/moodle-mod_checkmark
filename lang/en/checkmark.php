...
$string['all_marked_presentation'] = 'All participants marked for a presentation';
$string['all_unknown'] = 'All with unknown attendance status';
$string['all_with_presentationgrading'] = 'All participants with a presentation';
$string['all_without_presentationgrading'] = 'All participants without a presentation';
...
$string['bulk_attendance'] = 'Attendance';
$string['bulk_general'] = 'General';
$string['bulk_grading'] = 'Grading';
...
$string['bulk_presentation'] = 'Presentation';
...
$string['checkmarkaddonpluginname'] = 'Checkmark add-on';
$string['checkmarkaddons'] = 'Checkmark add-ons';
...
$string['coursetitle'] = 'File name with...';
$string['coursetitle_help'] = 'Define here if the course short name or the course full name is used in the name of the export file.';
...
$string['hidepresentationtoggle'] = 'Hide Presentation';
...
$string['invalidsubplugintype'] = 'Invalid Checkmark subplugin type: {$a}';
...
$string['managecheckmarkaddonplugins'] = 'Manage Checkmark add-ons';
...
$string['presentationstatus'] = 'Presentation';
$string['presentationstatus_marked'] = 'Marked';
$string['presentationstatus_no'] = 'No';
$string['presentationstatus_yes'] = 'Yes';
$string['presentationtimemodified'] = 'Last modified (Presentation)';
$string['printsettingstitle'] = 'Export settings';
$string['privacy:metadata:attendance'] = 'User\'s attendance status.';
$string['privacy:metadata:checkmarkaddonsummary'] = 'Data stored by Checkmark add-ons.';
...
$string['privacy:metadata:gradetimemodified'] = 'The most recent time and date the grade or comment got updated/modified.';
...
$string['privacy:metadata:pref:coursetitle'] = 'The default setting whether to use the course full name or short name for the export title.';
$string['privacy:metadata:pref:exporttemplate'] = 'The default export template to use for this user when exporting submissions.';
$string['privacy:metadata:pref:filter'] = 'The default filter to use when displaying submission tables (under "optional settings").';
$string['privacy:metadata:pref:filterexport'] = 'The default filter to use when exporting submissions.';
...
$string['privacy:metadata:pref:seperatenamecolumns'] = 'Should the fullname be split into single columns by default for this user?';
$string['privacy:metadata:pref:sequentialnumbering'] = 'The default setting whether or not to use sequential numbering of rows when exporting submissions as PDF.';
...
$string['privacy:metadata:presentationstatus'] = 'Status of the user\'s presentation.';
$string['privacy:metadata:presentationtimemodified'] = 'The most recent time and date the presentation status, grade or comment got updated/modified.';
...
$string['settings'] = 'Checkmark settings';
$string['showalltoggle'] = 'Show all examples';
$string['showpresentationtoggle'] = 'Show Presentation';
...
$string['strpresentation'] = 'Presentation';
