...
$string['example_preview_title_help'] = 'Here you see a preview of the coursemodules examples as configured in the settings. This preview will be replaced by the actual submission for all users allowed to submit and with a submission already done.';
