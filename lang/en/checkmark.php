...
$string['pdfpageorientation'] = 'PDF-Page orientation';
...
$string['pdfprintheader'] = 'Print PDF-header/-footer';
$string['pdfprintheader_help'] = ' print header/footer in pdf if checked';
$string['pdfprintheaderlong'] = 'print header/footer in pdf if checked';
...
$string['strsum'] = 'Sum';
$string['pdftextsize'] = 'PDF-Textsize';
...
$string['pdfpagesize'] = 'Submissions shown per page in PDF';
