...
====================================================================================================
    ...
    (i.e. examples to solve) which the student afterwards checks if he's able to solve them.
    ...
    *) using either standard examples (individual starting-number and examplecount,
...
included a JS-driven link or non-JS-driven button to select/deselect all submissions
